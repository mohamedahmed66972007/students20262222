...
export const SubjectIcon: React.FC<SubjectIconProps> = ({ subject, size = 24, className }) => {
  switch (subject) {
    case "arabic":
      return <BookText size={size} className={cn("text-blue-600 dark:text-blue-400", className)} />;
    case "english":
      return <Languages size={size} className={cn("text-green-600 dark:text-green-400", className)} />;
    case "math":
      return <Calculator size={size} className={cn("text-red-600 dark:text-red-400", className)} />;
    case "chemistry":
      return <FlaskRound size={size} className={cn("text-purple-600 dark:text-purple-400", className)} />;
    case "physics":
      return <Atom size={size} className={cn("text-yellow-600 dark:text-yellow-400", className)} />;
    case "biology":
      return <Dna size={size} className={cn("text-emerald-600 dark:text-emerald-400", className)} />;
    case "constitution":
      return <GraduationCap size={size} className={cn("text-orange-600 dark:text-orange-400", className)} />;
    case "islamic":
      return <BookOpenText size={size} className={cn("text-teal-600 dark:text-teal-400", className)} />;
    case "computer":
